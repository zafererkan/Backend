            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CrDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6109),
                            ModDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6120)
                        },
                        new
                        {
                            Id = 2,
                            ClaimCode = "editor",
                            ClaimName = "Editör",
                            CrDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6124),
                            ModDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6124)
                        },
                        new
                        {
                            Id = 3,
                            ClaimCode = "user",
                            ClaimName = "user",
                            CrDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6126),
                            ModDate = new DateTime(2024, 3, 20, 21, 24, 9, 435, DateTimeKind.Local).AddTicks(6127)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppClaimId = 1,
                            AppUserId = 1,
                            CrDate = new DateTime(2024, 3, 20, 21, 24, 9, 437, DateTimeKind.Local).AddTicks(626),
                            ModDate = new DateTime(2024, 3, 20, 21, 24, 9, 437, DateTimeKind.Local).AddTicks(631)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CrDate = new DateTime(2024, 3, 20, 21, 24, 9, 439, DateTimeKind.Local).AddTicks(3141),
                            Email = "SRDR",
                            EmailConfirmed = "E",
                            ModDate = new DateTime(2024, 3, 20, 21, 24, 9, 439, DateTimeKind.Local).AddTicks(3146),
                            Name = "Serdar",
