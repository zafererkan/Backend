            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CrDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1925),
                            ModDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1933)
                        },
                        new
                        {
                            Id = 2,
                            ClaimCode = "editor",
                            ClaimName = "Editör",
                            CrDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1936),
                            ModDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1936)
                        },
                        new
                        {
                            Id = 3,
                            ClaimCode = "user",
                            ClaimName = "user",
                            CrDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1937),
                            ModDate = new DateTime(2024, 3, 3, 16, 1, 21, 315, DateTimeKind.Local).AddTicks(1937)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppClaimId = 1,
                            AppUserId = 1,
                            CrDate = new DateTime(2024, 3, 3, 16, 1, 21, 316, DateTimeKind.Local).AddTicks(418),
                            ModDate = new DateTime(2024, 3, 3, 16, 1, 21, 316, DateTimeKind.Local).AddTicks(421)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CrDate = new DateTime(2024, 3, 3, 16, 1, 21, 317, DateTimeKind.Local).AddTicks(3280),
                            Email = "SRDR",
                            EmailConfirmed = "E",
                            ModDate = new DateTime(2024, 3, 3, 16, 1, 21, 317, DateTimeKind.Local).AddTicks(3283),
                            Name = "Serdar",
