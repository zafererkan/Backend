...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2699),
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2709)
                        },
                        new
                        {
                            Id = 2,
                            ClaimCode = "editor",
                            ClaimName = "Editör",
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2712),
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2713)
                        },
                        new
                        {
                            Id = 3,
                            ClaimCode = "user",
                            ClaimName = "user",
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2714),
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 926, DateTimeKind.Local).AddTicks(2714)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserClaimEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppClaimId = 1,
                            AppUserId = 1,
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 927, DateTimeKind.Local).AddTicks(2731),
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 927, DateTimeKind.Local).AddTicks(2737)
                        });
                });
            ...
            modelBuilder.Entity("Sobis.Core.Entities.Concrete.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 928, DateTimeKind.Local).AddTicks(7113),
                            Email = "SRDR",
                            EmailConfirmed = "E",
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 928, DateTimeKind.Local).AddTicks(7116),
                            Name = "Serdar",
            ...
            modelBuilder.Entity("Sobis.Entities.Concrete.District.DistrictEntity", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex(new[] { "CityId" }, "DISTRICT_X1");
            ...
            modelBuilder.Entity("Sobis.Entities.Concrete.Parameter.ParameterDetailEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(5674),
                            Data = 1,
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(5683),
                        ...
                        {
                            Id = 2,
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(5687),
                            Data = 2,
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(5687),
            ...
            modelBuilder.Entity("Sobis.Entities.Concrete.Parameter.ParameterEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CrDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(8932),
                            ModDate = new DateTime(2024, 4, 6, 0, 34, 53, 941, DateTimeKind.Local).AddTicks(8935),
            ...
            modelBuilder.Entity("Sobis.Entities.Concrete.District.DistrictEntity", b =>
                {
                    b.HasOne("Sobis.Entities.Concrete.City.CityEntity", "City")
                        .WithMany("Districts")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("DISTRICT_FK1");
